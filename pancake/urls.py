...
urlpatterns = [
                  ...
                  re_path(
                      r'^get_shifts/(?P<start>20(?:19|2[0-9])-(?:0[1-9]|1[012])-(?:[012][0-9]|3[01]))/(?P<end>20(?:19|2[0-9])-(?:0[1-9]|1[012])-(?:[012][0-9]|3[01]))/$',
                      views_get.get_shifts,
                      name='get_shifts'),

                  re_path(
                      r'^get_shift_detail/(?P<date>(?:2019|202[0-9])-(?:0[1-9]|1[01])-(?:0[1-9]|[12][0-9]|3[01]))/$',
